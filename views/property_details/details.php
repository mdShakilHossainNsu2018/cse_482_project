            ...
            <div class="card">
                ...
                <div class="product-content">
                    ...
                    <div class="product-price">
                        <p style="font-size:25px !important;" class="new-price">Price:
                            <span><?php echo $property["price"] ?> BDT</span></p>
                    </div>
                    ...
                    <div class="product-detail">
                        ...
                        <ul>
                            <li style="font-size:15px !important;">Area: <span
                                        style="font-size:12px !important;"><?php echo $property["area"] ?> SQFT</span>
                            </li>
                            <li style="font-size:15px !important;">Beds: <span
                                        style="font-size:12px !important;"><?php echo $property["beds"] ?></span></li>
                            <li style="font-size:15px !important;">Baths: <span
                                        style="font-size:12px !important;"><?php echo $property["baths"] ?></span></li>

                        </ul>
                    </div>

                    <div class="purchase-info">
                        <a href="<?php echo $property["phone"] != null ? 'tel:' . $property['phone'] : '#' ?>"
